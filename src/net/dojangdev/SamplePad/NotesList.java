package net.dojangdev.SamplePad;

import net.dojangdev.SamplePad.NotePad;
import net.dojangdev.SamplePad.R;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.menu_add:
          ...
          // startActivity(new Intent(Intent.ACTION_INSERT, getIntent().getData()));
        	Intent testIntent = new Intent(Intent.ACTION_INSERT, getIntent().getData(), this, NoteEditor.class);
